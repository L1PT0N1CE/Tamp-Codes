...
(function() {
    ...
    // Dynamisch jQuery laden, falls es nicht verfügbar ist
    if (typeof jQuery === 'undefined') {
        var script = document.createElement('script');
        script.src = "https://code.jquery.com/jquery-3.6.0.min.js";
        script.onload = function() {
            console.log('jQuery geladen');
            mainScript(); // Führe das Hauptskript aus, wenn jQuery geladen wurde
        };
        document.head.appendChild(script);
    } else {
        mainScript(); // Wenn jQuery bereits geladen ist, direkt das Hauptskript ausführen
    }
